 ...
 *
 */
public class StatisticaPlessoPrimaria {
	...
	private HashMap<Integer, Primaria> bambiniPerTipoIscrizione = new HashMap<Integer, Primaria>();
	
	private HashMap<Integer, Integer> bambiniPerAnnoSolare = new HashMap<Integer, Integer>();
	
	/**
	 * Medoto che restituisce il bean <code>Primaria</code> di uno specifico anno scolastico
	 * 
	 * @param annoScolasticoInf rappresenta l'anno inferiore dell'anno scolastico
	 * @return
	 */
	public Primaria getPrimaria(int annoScolasticoInf){
		
		Integer asMin = new Integer(annoScolasticoInf);
		
		if(!bambiniPerTipoIscrizione.containsKey(asMin)){
			Primaria primaria = new Primaria(annoScolasticoInf);       
			this.bambiniPerTipoIscrizione.put(annoScolasticoInf, primaria);
		}
		
		return (Primaria)bambiniPerTipoIscrizione.get(annoScolasticoInf);
	}
	...
	public void addIscrizioniObbligatorie(int annoScolasticoInf) {
		getPrimaria(annoScolasticoInf).addIscrizioniObbligatorie();
	}
	
	/**
	 * Metodo che addiziona le iscrizioni facoltative per uno specifico anno scolastico
	 * @param annoScolasticoInf rappresenta l'anno inferiore dell'anno scolastico
	 */
	public void addIscrizioniFacoltative(int annoScolasticoInf) {
		getPrimaria(annoScolasticoInf).addIscrizioniFacoltative();
	}
	
	/**
	 * Metodo che restituisce la somma tra le iscrizioni obbligatorie e quelle facoltative
	 * @param annoScolasticoInf rappresenta l'anno inferiore dell'anno scolastico
	 * @return la somma tra le iscrizioni obbligatorie e facoltative
	 */
	public int getTotIscrizioni(int annoScolasticoInf) {
		return getPrimaria(annoScolasticoInf).getTotIscrizioni();
	}
	...
	public void addIscrizioniObbligatorieClassiPrime(int annoScolasticoInf) {
		getPrimaria(annoScolasticoInf).addIscrizioniObbligatorieClassePrima();
	}
	...
	public void setCapienzaClassiPrime(int annoScolasticoInf, int capienzaClassiPrime) {
		getPrimaria(annoScolasticoInf).setCapienzaClassiPrime(capienzaClassiPrime);
	}
	...
	public int getDifferenza(int annoScolasticoInf) {
		return getPrimaria(annoScolasticoInf).getDifferenza();
	}
