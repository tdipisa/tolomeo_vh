...
import it.prato.comune.sit.plugin.comunePO.poliziaMunicipale.LayerSinistriInfor;
import it.prato.comune.sit.plugin.comunePO.poliziaMunicipale.PuntoSinistro;
import it.prato.comune.sit.plugin.comunePO.poliziaMunicipale.PuntoSinistroInfor;
...
public class VisualizzaSinistroInforServlet extends TolomeoServlet {    
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, java.io.IOException {
        ...
        PuntoSinistroInfor sinistro = null;
        String JSGeometry = null;
        
        try {
                    
            comunePO = getTerritorio(logger);
            LayerSinistriInfor sinistri = (LayerSinistriInfor) comunePO.getLayerByCodTPN(codTPN);
            
            //se il sinistro non e' presente in request lo cerco tramite la key
            //if (sinistro == null) {
    	        ...
    	        //cerco sinistro
    			sinistro = (PuntoSinistroInfor) sinistri.cercaIDTPN(key);
            ...
            try {
    			...
    			String errMsg = "Si e' verificata un'eccezione durante il recupero dei dati";
	...
	protected String getDefaultForward() {
		return "/jsp/servizi/poliziaMunicipale/visualizzaSinistroInfor.jsp";
	}
}
