...
public class FasciaEta {
	...
	private int interSup;
	private int maschi;
	private int femmine;
	private int italiani;
	private int stranieri;
	private int totFascia;
	
	public int getInterInf() {
		return interInf;
	}
	public void setInterInf(int interInf) {
		this.interInf = interInf;
	}
	public int getInterSup() {
		return interSup;
	}
	public void setInterSup(int interSup) {
	...
	public int getTotFascia() {
		// per poter avere anche i soli totalizzatori
		return Math.max(Math.max(getFemmine()+getMaschi(), getStranieri()+getItaliani()),this.totFascia);
	}
	public void setTotFascia(int totFascia) {
		this.totFascia = totFascia;
	}
}
