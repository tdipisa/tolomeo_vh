...
public class CaricaDatiEsempioBaseServlet extends TolomeoServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, java.io.IOException {
    	...
    	//List<Messaggio> messsaggi = (ArrayList<Messaggio>)request.getAttribute("messaggi");
		...
		try {
			...
			LayerSinistri sinistri = (LayerSinistri) comunePO.getLayerByCodTPN(Integer.parseInt(codTPN));
