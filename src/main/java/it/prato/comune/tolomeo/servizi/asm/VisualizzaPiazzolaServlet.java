 ...
 * sit@comune.prato.it
 ******************************************************************************/
package it.prato.comune.tolomeo.servizi.asm;

import it.prato.comune.sit.LayerPiazzoleASM;
import it.prato.comune.sit.PuntoPiazzolaASM;
...
public class VisualizzaPiazzolaServlet extends TolomeoServlet {

	private static final long serialVersionUID = -3994832582347639238L;
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, java.io.IOException {
		...
		LayerPiazzoleASM piazzole = LayerPiazzoleASM.getInstance(comunePO);
		
		// Cerco piazzola selezionata
		PuntoPiazzolaASM piazzola = (PuntoPiazzolaASM) piazzole.cercaIDTPN(key);
        if(piazzola == null){
            String errMsg = "Piazzola " + key + " non trovata";
            logger.error(errMsg);
        ...
        try {
        	...
        	JSGeometry = piazzola.getJSGeometry();
		...
		request.setAttribute("piazzola",piazzola);
