...
(function() {
    ...
    if (includeCSS) {
    	...
    	//document.write('<link rel="stylesheet" type="text/css" href="/js/ext/extJS/resources/css/ext-all' + suffix + '-debug.css"/>');
    }
    document.write('<script type="text/javascript" src="' + path + '/ext-all' + (rtl ? '-rtl' : '') + '.js"></script>');
    //document.write('<script type="text/javascript" src="/js/ext/extJS/ext-all' + (rtl ? '-rtl' : '') + '.js"></script>');
