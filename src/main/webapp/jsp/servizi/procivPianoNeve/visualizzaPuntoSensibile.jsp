...
<%
	...
	PuntoPuntiSensibili puntoSensibile = (PuntoPuntiSensibili) request.getAttribute("puntoSensibile");
%>
...
<%@ include file="include/pageHeader.jsp" %>
	...
	<form action="">
		<fieldset>
			<legend>Punto sensibile</legend>
			<div>
				<span class="tmpl_form_etichetta">Nome:</span>
				<span class="tmpl_form_fixtext">${puntoSensibile.nome}</span>
			</div>
			<div>
				<span class="tmpl_form_etichetta">Tipo:</span>
				<span class="tmpl_form_fixtext">${puntoSensibile.tipo}</span>
			</div>
			<div>
				<span class="tmpl_form_etichetta">Indirizzo:</span>
				<span class="tmpl_form_fixtext">${puntoSensibile.indirizzo}</span>
			</div>
			<div>
				<span class="tmpl_form_etichetta">Squadra:</span>
				<span class="tmpl_form_fixtext">${puntoSensibile.squadra}</span>
			</div>
			<div>
				<span class="tmpl_form_etichetta">Circoscrizione:</span>
				<span class="tmpl_form_fixtext">${puntoSensibile.circoscrizione}</span>
			</div>
			<div>
				<span class="tmpl_form_etichetta">Priorità:</span>
				<span class="tmpl_form_fixtext">${puntoSensibile.priorita}</span>
			</div>
			<div>
				<span class="tmpl_form_etichetta">Note:</span>
				<span class="tmpl_form_fixtext">${puntoSensibile.note}</span>
			</div>
		</fieldset>
	</form>
