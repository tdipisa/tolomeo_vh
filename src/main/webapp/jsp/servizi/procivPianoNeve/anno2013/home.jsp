<%--
 ...
 sit@comune.prato.it
--%>
<%@page import="it.prato.comune.sit.plugin.comunePO.beans.pianoNeve.anno2013.LivelloBean"%>
<%@page import="java.util.ArrayList"%>
<%@page import="java.util.List"%>
<%
	List<LivelloBean> livelli = (ArrayList<LivelloBean>) request.getAttribute("livelli");
%>
...
<%@ include file="include/pageHeader.jsp" %>
	...
	<%
		for (LivelloBean livello: livelli) {
	%>
		<li>
			<h2><%= livello.getNome() %></h2>
			<div><h3 style="margin-bottom:0">Situazione: </h3><%= livello.getSituazione() %></div>
			<div><h3 style="margin-bottom:0">Fasi e provvedimenti: </h3><%= livello.getFase() %></div>
		</li>
	<% } %>
	</ul>
