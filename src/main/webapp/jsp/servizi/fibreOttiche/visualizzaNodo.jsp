<%--
 ...
 sit@comune.prato.it
--%>
<%@page import="it.prato.comune.sit.plugin.comunePO.fibreOttiche.PuntoNodo"%>
...
<form action="">
		...
		<fieldset>
			...
			<div>
				...
				<span class="tmpl_form_fixtext">${nodo.codice}</span>
			</div>
			<div>
				<span class="tmpl_form_etichetta">Nome:</span>
				<span class="tmpl_form_fixtext">${nodo.nome}</span>
			</div>
			<div>
				<span class="tmpl_form_etichetta">Toponimo:</span>
				<span class="tmpl_form_fixtext">${nodo.toponimo}</span>
			</div>
			<div>
				<span class="tmpl_form_etichetta">Note:</span>
				<span class="tmpl_form_fixtext">${nodo.note}</span>
			</div>
		</fieldset>
