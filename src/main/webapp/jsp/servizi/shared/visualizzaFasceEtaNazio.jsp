	...
	<table summary="Residenti suddivisi per fasce di età">
		...
		<thead>
			<tr>
				...
				<th id="col3"><abbr title="Residenti stranieri">Stranieri</abbr></th>
		...
		<tbody>
			<c:forEach items="${statisticaCompletaFasceEta.statisticaFasceEta.fasceEta}" var="row" varStatus="rowStatus">
				...
				<td headers="col2"><c:out value="${row.italiani}" /></td>
				<td headers="col3"><c:out value="${row.stranieri}" /></td>
			...
			<tr class="tmpl_rigatot">
				...
				<td headers="col4" class="tmpl_col_dx">${statisticaCompletaFasceEta.statisticaFasceEta.totGlobaleItaStra}</td>
			</tr>
		</tbody>
	</table>
