...
$(function(){
	if($('div#listaDitte')){
		var qs = $('input#id_search_list').quicksearch('ul#listaDitteUL li');
		/*
		$('ul#listaDitteUL li').quicksearch({
		  position: 'append',
		  attached: 'div#listaDitte',
		...
		<c:choose>									
			<c:when test="${!empty ditte}">
				...
				<c:forEach items="${ditte}" var="ditta" varStatus="status">
					<li>	
						<a href="/tolomeobinj/glup/GestioneDitta?operazione=V&idDitta=${ditta.id}">					 
