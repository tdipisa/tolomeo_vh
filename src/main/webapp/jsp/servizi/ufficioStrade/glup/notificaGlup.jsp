...
<body id="tmpl_popup">
	...
	<h2><c:out value="${pageTitle}" default="Notifiche : " /></h2>
	<br />
	<%@ include file="../../../include/tmplMessaggio.jsp" %>
	<br />
	<form id="notificaGlup" action="/tolomeobinj/jsp/servizi/ufficioStrade/glup/homeGlup.jsp" method="post">
