...
<% 
	StatisticaArea statistica = (StatisticaArea) request.getAttribute("statistica"); 
	...
	<form action="VisualizzaIntersectAnagrafeServlet" method="post">
		<fieldset>
			...
			<div>
				...
				<span class="tmpl_form_fixtext">${statistica.residenti}</span>
			</div>
			<div>
				<span class="tmpl_form_etichetta">Densità di popolazione per ettaro:</span>
				<span class="tmpl_form_fixtext">${statistica.densita}</span>
			</div>
			<div>
				<span class="tmpl_form_etichetta">Nuclei familiari:</span>
				<span class="tmpl_form_fixtext">${statistica.famiglie}</span>
			</div>
		...
		<div class="tmpl_bottoni">
			<c:choose>
				<c:when test="${statistica.residenti > 0}">
