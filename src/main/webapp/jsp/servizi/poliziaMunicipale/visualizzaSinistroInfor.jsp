...
sit@comune.prato.it
--%>
<%@page import="it.prato.comune.sit.plugin.comunePO.poliziaMunicipale.PuntoSinistroInfor"%>
<% PuntoSinistroInfor sinistro = (PuntoSinistroInfor)request.getAttribute("sinistro"); %>
...
<%@ include file="../../include/tmplBaseUPPannello.jsp" %>
	...
	<form action="">
		...
		<fieldset>
			...
			<div>
				<span class="tmpl_form_etichetta">Anno:</span>
				<span class="tmpl_form_fixtext">${sinistro.anno}</span>
			</div>
			<div>
				<span class="tmpl_form_etichetta">Numero:</span>
				<span class="tmpl_form_fixtext">${sinistro.NSinistro}</span>
			</div>
			<div>
				<span class="tmpl_form_etichetta">Coordinata X:</span>
				<span class="tmpl_form_fixtext"><fmt:formatNumber value="${sinistro.centroide.x}" maxFractionDigits="2" minFractionDigits="2" type="number" pattern="#"></fmt:formatNumber></span>
			</div>
			<div>
				<span class="tmpl_form_etichetta">Coordinata Y:</span>
				<span class="tmpl_form_fixtext"><fmt:formatNumber value="${sinistro.centroide.y}" maxFractionDigits="2" minFractionDigits="2" type="number" pattern="#"></fmt:formatNumber></span>
			</div>
		</fieldset>
