...
beforeSearchHandler = function(params) {
	var message = "<ul>";
	message += "<li>freeText = \"" + params.freeText + "\"</li>";
	message += "<li>lastModifiedBegin = \"" + params.lastModifiedBegin + "\"</li>";
	message += "<li>lastModifiedEnd = \"" + params.lastModifiedEnd + "\"</li>";
	message += "<li>useBbox = " + params.useBbox + "</li>";
	message += "<li>dcValue = \"" + params.dcValue + "\"</li>";
	message += "<li>useAdvancedSearch = " + params.useAdvancedSearch + "</li>";	 
	message += "</ul>";
	Ext.Msg.show({
		title:'Parametri',
		msg : message,
